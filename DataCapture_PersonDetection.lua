...
--4. chirp sayısı
--5. periodicity
if (ar1.FrameConfig(0, 0, 500, 128, 120, 0, 0, 0) == 0) then
...
for count = 1, 20 do
    -- Iterate through the list using ipairs
		...
		RSTD.Sleep(3000)
		adc_data_path = "C:\\ti\\mmwave_studio_02_01_01_00\\mmWaveStudio\\PostProc\\person_counting_data\\3people\\adc_data_" ..count.. ".bin" 
