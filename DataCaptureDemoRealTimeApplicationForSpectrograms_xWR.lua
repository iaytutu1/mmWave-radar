...
--4. chirp sayısı
--5. periodicity
if (ar1.FrameConfig(0, 0, 1, 128, 100, 0, 0, 0) == 0) then
...
-- Define the list
vowels = {'radar_watcher_directory'}
-- {'a', 'e', 'i','o', 'y'}

-- listen and display başla
...
for count = 1, 20 do
    ...
    for _, vowel in ipairs(vowels) do
		...
		RSTD.Sleep(2000)
		adc_data_path = "C:\\ti\\mmwave_studio_02_01_01_00\\mmWaveStudio\\PostProc\\vowels_correct\\" ..vowel.. "\\adc_data_" ..count.. ".bin" 
